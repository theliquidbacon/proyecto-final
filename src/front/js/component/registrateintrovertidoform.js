...
export function RegistrateintrovertidoForm() {
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-4 ms-5" style={{ marginTop: "13rem" }}>
                    <h4>"¡Conéctate y comparte lo que piensas seguro hay mucha gente como tu que se interesa por lo mismo!"</h4>
                    <h4 style={{ marginTop: "9rem" }} >"Descubre nuevas amistades, déjate llevar y verás que la vida con gente a tu lado es mas fácil" </h4>
                </div>
            </div>
        </div>
    );
